...
//除了登录接口,其他的后台接口认证统一使用 Token 认证
//说明以后我们每次发送ajax请求, 都要带headers过去. 那就很烦人了
//那如何解决这个问题呢?

//能不能设置一个方法,在每次发ajax请求之前都执行这个方法,
//那就可以把发送header的写在这个方法里.
$.ajaxSetup({
  //发送请求前运行的函数。
...
//每一个页面都要引入jQuery.js文件
//那还可以把这个方法写在jQuery.js中.
